...
const file_proto_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x18proto/user/v1/user.proto\x12\auser.v1\"d\n" +
	"\x04User\x12\x0e\n" +
	...
	"\x04user\x18\x01 \x01(\v2\r.user.v1.UserR\x04user2b\n" +
	"\vUserService\x12S\n" +
	"\x0eGetUserByEmail\x12\x1e.user.v1.GetUserByEmailRequest\x1a\x1f.user.v1.GetUserByEmailResponse\"\x00BIZGgithub.com/thawthuhan/api-gateway-lab/auth-service/proto/user/v1;userv1b\x06proto3"
...
var file_proto_user_v1_user_proto_depIdxs = []int32{
	...
	1, // 1: user.v1.UserService.GetUserByEmail:input_type -> user.v1.GetUserByEmailRequest
	2, // 2: user.v1.UserService.GetUserByEmail:output_type -> user.v1.GetUserByEmailResponse
